...
import it.giovanni.arkivio.fragments.detail.puntonet.workmanager.workers.SaveImageToFileWorker
...
class BlurViewModel(application: Application) : ViewModel() {
    ...
    val workInfos: LiveData<List<WorkInfo>> = workManager.getWorkInfosByTagLiveData(TAG_OUTPUT)
    ...
    /**
     * Creates the input data bundle which includes the Uri to operate on @return Data which
     * contains the Image Uri as a String
     */
