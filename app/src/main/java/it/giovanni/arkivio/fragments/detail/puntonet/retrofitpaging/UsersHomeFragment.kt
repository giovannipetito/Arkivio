...
class UsersHomeFragment : DetailFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.buttonGetUsersPaging?.setOnClickListener {
            currentActivity.openDetail(Globals.USERS_PAGING, null)
        }
        ...
        if (isDarkMode) {
            ...
            binding?.buttonGetUsersPaging?.style(R.style.ButtonNormalDarkMode)
            binding?.buttonAddUser?.style(R.style.ButtonNormalDarkMode)
        }
        else {
            binding?.buttonGetUsers?.style(R.style.ButtonNormalLightMode)
            binding?.buttonGetUsersPaging?.style(R.style.ButtonNormalLightMode)
