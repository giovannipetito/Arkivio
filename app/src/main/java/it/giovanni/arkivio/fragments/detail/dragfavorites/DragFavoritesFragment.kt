...
class DragFavoritesFragment : DetailFragment(), OnAdapterListener {
    ...
    private val viewModel: DragFavoritesViewModel by viewModels()

    private lateinit var personalsAdapter: DragFavoritesAdapter
    private lateinit var availablesAdapter: DragFavoritesAdapter

    private var title: Int = R.string.drag_favorites_title
    ...
    private fun setupRecyclerViews() {
        ...
        personalsAdapter = DragFavoritesAdapter(true, onAdapterListener = this)
        ...
        availablesAdapter = DragFavoritesAdapter(false, onAdapterListener = this)
            ...
            gridLayoutManager.spanSizeLookup = object : GridLayoutManager.SpanSizeLookup() {
                override fun getSpanSize(position: Int): Int {
                    return when (availablesAdapter.getItemViewType(position)) {
                        DragFavoritesAdapter.VIEW_TYPE_HEADER -> gridLayoutManager.spanCount // Span all columns for headers
    ...
    private fun refreshAdapter(adapter: DragFavoritesAdapter) {
