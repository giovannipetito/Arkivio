...
import it.giovanni.kotlin.youtube.*
import it.giovanni.kotlin.youtube.IntentControlsActivity
import it.giovanni.kotlin.youtube.intents.YouTubeIntentsActivity
import it.giovanni.kotlin.youtube.videolist.VideoListActivity
import it.giovanni.kotlin.youtube.videowall.VideoWallActivity
import kotlinx.android.synthetic.main.youtube_manager_layout.*

class YouTubeManagerFragment : DetailFragment() {

    private var viewFragment: View? = null

    override fun getLayout(): Int {
        return R.layout.youtube_manager_layout
    }
